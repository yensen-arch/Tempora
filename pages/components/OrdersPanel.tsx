              ...
              <div className="flex flex-1 justify-between sm:hidden">
                <button
                  ...
                  className={`relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium ${
                    pagination.hasPrevPage ? 'text-gray-700 hover:bg-gray-50' : 'text-gray-300'
                  }`}
                >
                  Previous
                </button>
              ...
              <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                <div>
                  <p className="text-sm text-gray-700">
                    Showing <span className="font-medium">{orders.length > 0 ? (pagination.page - 1) * pagination.limit + 1 : 0}</span> to{" "}
                  ...
                  <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                    ...
                    <button
                      ...
                      className={`relative inline-flex items-center px-2 py-2 ${
                        !pagination.hasPrevPage ? 'text-gray-300' : 'text-gray-500 hover:bg-gray-50'
                      }`}
                    >
                    ...
                    <button
                      ...
                      disabled={!pagination.hasNextPage}
                      className={`relative inline-flex items-center px-2 py-2 ${
                        !pagination.hasNextPage ? 'text-gray-300' : 'text-gray-500 hover:bg-gray-50'
                      }`}
                    >
